            ...
            @elseif($request->seviye==1)
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo $story->parentStory->metin ?> <br> <a href="?op=profil&kullanici=<?php echo $story->parentStory->user->ad  ?>"><?php echo $story->parentStory->user->ad ?></a>(<?php echo $story->parentStory->created_at ?>)</p>
                <p class="card-text"><?php echo $story->metin ?> <br> <a href="{{route('profil'),$story->user->ad}}"><?php echo $story->user->ad ?></a>(<?php echo $story->created_at ?>)</p>
                </div>
              </div>
              @endif
